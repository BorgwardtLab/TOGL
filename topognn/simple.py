...
def main(args):
    ...
    if model_type=="GCN":
        ...
        model = models.FiltrationGCNModel(hidden_dim=32, num_node_features=data.node_attributes,
                     num_classes=data.num_classes, num_filtrations = 2, num_coord_funs = num_coord_funs )
    else:
